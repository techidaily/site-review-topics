...
keyword: forgotten screen lock,remove PIN,turn off screen lock,turn off Itel fingerprint,remove lock screen,remove Itel P40+ fingerprint,how to unlock android phone if i forget the password,remove android lock screen,remove android phone PIN,remove android phone password,remove android fingerprint,forgotten my android phone's lock
---
