...
categories: 
  - unlock
  - ios
description: How to Remove iPhone 6s Face ID? This article will show you how to remove Face ID on iPhone 6s.
keywords: Use Face ID to Pay for Apple Books Purchases on iPhone 6s,Use Face ID make purchases on iPhone 6s,Use Face ID to Pay for Apple Music on iPhone 6s,Use Face ID to Pay for Apple TV+ on iPhone 6s,Bypass iPhone 6s Face ID,Set up iPhone 6s Face ID
---
...
Along with Passcode comes the option of Face ID on your iPhone 6s, so use that. That will minimize instances for you to enter your passcode, and may make you forget it again, though. So, make sure that the passcode you set does make sense to you and you can remember it always without effort.
