...
categories: 
  - unlock
  - ios
description: What can you do with Face ID on iPhone XS? This article will show you what can you do with Face ID on iPhone XS.
keywords: What can you do with Face ID on iPhone XS,Bypass iPhone XS Face ID,Set up iPhone XS Face ID,Use Face ID to Pay for Apple TV+ on iPhone XS,Use Face ID to Pay for iTunes & App Store Purchases on iPhone XS,Use Face ID make purchases on iPhone XS
---
...
Once you have activated the `Find My iPhone` function, then you can try it to unlock your iPhone XS without a passcode. This is an easy and effective method to complete this task. Here's how you can do it:
