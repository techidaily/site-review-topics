...
categories: 
  - unlock
  - ios
description: How to Use Face ID to Pay for Apple Music on iPhone 6s Plus This article will show you how to use Face ID to pay for Apple Music on iPhone 6s Plus.
keywords: Set up iPhone 6s Plus Face ID,Use Face ID to Pay for Apple Music on iPhone 6s Plus,Use Face ID to Pay for Apple TV+ on iPhone 6s Plus,Remove iPhone 6s Plus Face ID,What can you do with Face ID on iPhone 6s Plus,Use Face ID to Pay for Apps on iPhone 6s Plus
---

<img src="https://img0mobiles.techidaily.com/images/best-assets/devices/apple/apple-iphone-6s-plus/3.jpg" class="atpl-imgstyle"  />
...
## How to use Face ID on iPhone 6s Plus to make purchases in App Store, Book Store, and iTunes Store
...
## How to Set Up Face ID on Your iPhone 6s Plus

Sometimes, you may just want to disable Face ID temporarily or the issue gets solved, and want to activate Face ID again. Setting up a Face ID on your iPhone 6s Plus is easy. To set up Face ID, sit in a comfortable spot with adequate lighting and follow these steps:
...
- **Step 3**: Hold your iPhone 6s Plus in the portrait orientation at about an arm‘s length away from your face and then tap Get Started.
...
There are a few things you can try to resolve this, you can try to update your iPhone 6s Plus to the latest iOS. At this point, you may even try running a beta version to see if that helps. If you are running a beta version, you may downgrade back to the release version to see if that resolves the error. Betas can both make and break things.
...
## How to Remove Face ID on iPhone 6s Plus
...
Lately, with the COVID-19 pandemic, we have seen how Face ID struggles to work for us, and why? Because it cannot scan our faces with masks! So, it makes sense to remove Face ID from our iPhones and rely solely on passcodes. Alternatively, you want to reset your Face ID on your iPhone 6s Plus and set it again if you have put on some 'COVID weight' owing to working from home.

Most of the time, the best and the simplest thing you can do to resolve your hardware and software issues is to restart the device in question. To restart your iPhone 6s Plus, long-press the Side Button until the power slider appears and drag it to shut the device off. Then, use the Side Button to start the phone again.

Sometimes, the issues have a way of persisting, and a restart does not resolve them. the TrueDepth system might have developed a fault and Face ID might stop working. Or you got the dreaded "problem detected with TrueDepth camera" message on your iPhone 6s Plus. In that case, you would like to know how to reset and remove Face ID on your iPhone 6s Plus to see if that helps, before you are required to go to an Apple Store for service.

- **Step 1**: Go to `Settings` > `Face ID and Passcode`.

- **Step 2**: Scroll and tap the option `"Reset Face ID"` to remove Face ID on your iPhone iPhone 6s Plus.
...
<li><a href="https://discord-videos.techidaily.com/updated-love-hunt-top-10-discord-dating-destinations-for-2024/"><u>[Updated] Love Hunt  Top 10 Discord Dating Destinations for 2024</u></a></li>
...
<li><a href="https://ai-vdieo-software.techidaily.com/2024-approved-facebook-video-formatting-essentials-aspect-ratios-and-more/"><u>2024 Approved Facebook Video Formatting Essentials Aspect Ratios and More</u></a></li>
