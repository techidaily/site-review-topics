...
categories: 
  - unlock
  - ios
description: How to Set up iPhone XS Max Face ID? This article will show you how to set up Face ID on iPhone XS Max.
keywords: Use Face ID make purchases on iPhone XS Max,What can you do with Face ID on iPhone XS Max,Bypass iPhone XS Max Face ID,Use Face ID to Pay for Apple TV+ on iPhone XS Max,Remove iPhone XS Max Face ID,Use Face ID to Pay for Apple Books Purchases on iPhone XS Max
---
...
Most of us know that we can unlock iPhone XS Max with our face via Face ID instead of a thumbprint or passcode. But actually, Face ID does more than just that. Let us learn more cool things you can do with Face ID, which helps you to make a decision if you still want to disable it. Here‘s what you can do on your iPhone XS Max with Face ID:

### Unlock Your iPhone XS Max

As an authentication mechanism, Face ID enables you to unlock your iPhone XS Max with a look. How to do that? Here are the steps:

- **Step1**: Pick your iPhone XS Max up in your hands or tap the screen to wake it up.
- **Step2**: Look at the iPhone.
  When the lock symbol changes to the unlocked position, you can swipe up to unlock your iPhone XS Max using Face ID and get to the Home Screen.Note that Face ID will not work in landscape mode on an iPhone XS Max.

### Making Purchases Using Face ID on Your iPhone XS Max
...
Here‘s how to send Animojis in conversations on your new iPhone XS Max:
...
## How to use Face ID on iPhone XS Max to make purchases in App Store, Book Store, and iTunes Store
...
<!-- affiliate ads end -->
## How to Remove Face ID on iPhone XS Max
...
Lately, with the COVID-19 pandemic, we have seen how Face ID struggles to work for us, and why? Because it cannot scan our faces with masks! So, it makes sense to remove Face ID from our iPhones and rely solely on passcodes. Alternatively, you want to reset your Face ID on your iPhone XS Max and set it again if you have put on some 'COVID weight' owing to working from home.

Most of the time, the best and the simplest thing you can do to resolve your hardware and software issues is to restart the device in question. To restart your iPhone XS Max, long-press the Side Button until the power slider appears and drag it to shut the device off. Then, use the Side Button to start the phone again.

Sometimes, the issues have a way of persisting, and a restart does not resolve them. the TrueDepth system might have developed a fault and Face ID might stop working. Or you got the dreaded "problem detected with TrueDepth camera" message on your iPhone XS Max. In that case, you would like to know how to reset and remove Face ID on your iPhone XS Max to see if that helps, before you are required to go to an Apple Store for service.

- **Step 1**: Go to `Settings` > `Face ID and Passcode`.

- **Step 2**: Scroll and tap the option `"Reset Face ID"` to remove Face ID on your iPhone iPhone XS Max.
