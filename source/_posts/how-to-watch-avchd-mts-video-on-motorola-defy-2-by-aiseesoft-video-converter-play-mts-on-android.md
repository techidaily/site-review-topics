...
categories: 
  ...
  - aiseesoft
  - video converter
description: What to do if your Motorola Defy 2 cannot play AVCHD .mts video clips? If you fail or have problems playing AVCHD MTS files on your Motorola Defy 2, you can follow our solution to solve the issue.
keywords: encode avchd to mp4 for Motorola ,convert avchd mts for Defy 2,watch avchd on Motorola Defy 2,mts playback on Defy 2,play avchd files on Motorola Defy 2,play avchd on Defy 2,best mts transcoder android,playing mts videos on phone android,mts converter for android,mts codec vlc android,mts video converter for android,mts converter android 2018
---
...
<div class="tpl-content-sub-paragraph-normal">
  <p>
    Surprised to find that your Motorola Defy 2 does not come with native support for AVCHD .MTS format used in many video cameras? By installing a third party media player like MX player will solve your problem. If this doesn’t work or you prefer to use the stock player, you can convert AVCHD files to MP4 format for playing on Motorola Defy 2.
  </p>
</div>
</div>
...
<div class="tpl-content-sub-paragraph-content">
  <p>
    Cannot view AVCHD MTS files on your Motorola Defy 2 flawlessly? The stock media player may refuse recognizing .mts file extension because Motorola Defy 2 doesn’t have native support for AVCHD mts video clips. However, you could always use an app like Video Converter to convert your AVCHD .mts files to .mp4 format on your computer and then move them to your Motorola Defy 2 for playback fluently without any incompatibility issues. In the guide below, we walk you through how to encode AVCHD MTS files to MP4 format for viewing on Motorola Defy 2 smoothly.
  </p>
</div>
</div>
