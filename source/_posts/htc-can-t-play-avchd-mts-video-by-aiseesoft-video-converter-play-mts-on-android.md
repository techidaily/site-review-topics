...
categories: 
  ...
  - aiseesoft
  - video converter
description: Surprised to find that your HTC U23 Pro does not come with native support for AVCHD .MTS format used in many video cameras? The problem can be solved by  converting AVCHD files to MP4 format. 
keywords: avchd player for HTC U23 Pro,mts converter for U23 Pro,mts playback on U23 Pro,watch avchd on HTC,avchd player for HTC,convert avchd mts for HTC,mts file not supported in HTC U23 Pro,mts converter for android,mts codec vlc android,mts converter android 2018,playing mts videos on phone android,HTC U23 Pro wont play mts
---
...
<div class="tpl-content-sub-paragraph-content">
  <p>
    Cannot view AVCHD MTS files on your HTC U23 Pro flawlessly? The stock media player may refuse recognizing .mts file extension because HTC U23 Pro doesn’t have native support for AVCHD mts video clips. However, you could always use an app like Video Converter to convert your AVCHD .mts files to .mp4 format on your computer and then move them to your HTC U23 Pro for playback fluently without any incompatibility issues. In the guide below, we walk you through how to encode AVCHD MTS files to MP4 format for viewing on HTC U23 Pro smoothly.
  </p>
</div>
</div>
