---
title: Huawei  won't play MOV videos, how to fix ?
date: 2024-04-12T01:35:51.836Z
tags: 
  - mov video
  - mov android
categories: 
  ...
  - aiseesoft
  - video converter
description: In order to play QuickTime MOV files on Huawei P60 without glitches, it is wise to get a professional MOV to Huawei P60 converter. With its help, you can easily convert MOV files into Huawei P60 preferred MP4 format. 
keywords: mov to Huawei  converter,does mov play on Huawei ,will mov play on P60,can't play .mov on Huawei ,watch .mov on Huawei P60,best app to play .mov on Huawei ,video to mp4 codec converter for android,mov codec vlc android,how to convert mov into h264 on android,how to converter 720p to mov on android,mov to mp4 video converter for android,best mov transcoder android
---
...
<div class="tpl-content-sub-paragraph-normal">
  <p>
    Will Huawei P60 support QuickTime .mov files? If you are having issues playing MOV files on Huawei P60, you are just here in the right place. This article explains how to get Huawei P60 playing MOV movies through the way of converting MOV files to MP4 format.
  </p>
</div>
</div>
...
<div class="tpl-content-sub-paragraph-question">
  “Hi guys, I just changed for the Huawei P60 about half a month ago and I'm very pleased with it and don't regret leaving Apple, saving for iTunes compatibility. Anyways can anyone please tell me if there's a way I could play my .mov videos taken with my old iPhone on my Huawei P60? Thanks.”
</div>
<div class="tpl-content-sub-paragraph-content">
<p>
  Since Huawei P60 does not support playback of .MOV files using its stock player, you will need to install a third party media player that supports QuickTime MOV, or process file conversion before the playback. To download a .mov player for your Huawei P60, you can give VLC player, MX Player, BS Player and Mobo player a shot. To convert MOV files for viewing on Huawei P60, you can give Video Converter a shot. You load your MOV files to this Converter app, and choose H.264 MP4 as output format. This will ensure the converted files have a good playback performance on your Huawei P60.
</p>
</div>
</div>
...
<img src="https://tools.techidaily.com/images/apps/aiseesoft/video-converter/devices/huawei/fv.mp4/win/profile-2.png" class="atpl-imgstyle" alt="Select output profile format for Huawei P60" />
