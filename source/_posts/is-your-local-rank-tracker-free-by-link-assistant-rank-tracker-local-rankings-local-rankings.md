...
categories: 
  - seo tools
  - link-assistant
description: Yes, the software has a free version. You'll have an unlimited number of projects and keywords you can track and research. That said, you will only be able to track one competitor per project. Head to the pricing page to compare different editions.
keywords: local seo,local seo software,local seo tool,local seo rank tracker,local seo rankings,local serp,local seo rank tracking,local seo rank tracking service,local seo rank tracking tool,local seo rank tracking software,local rank tracker,local rankings
---
