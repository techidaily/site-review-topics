...
categories: 
  ...
  - aiseesoft
  - video converter
description: Trying to play AVCHD MTS video clips on your Motorola Razr 40 but failed? All you need is a useful AVCHD to Motorola Razr 40 converter. Check how to re-encode AVCHD .mts files to H.264 MP4 format for playing back on Motorola Razr 40 without any hassles. 
keywords: encode avchd to mp4 for Motorola Razr 40,avchd to Motorola Razr 40 converter,play avchd files on Motorola ,Motorola  playback AVCHD,view mts files on Motorola ,play mts on Motorola Razr 40,video to mts converter for android,mts converter for android,best mts transcoder android,video to mts codec converter for android,mts file not supported in Motorola Razr 40,playing mts videos on phone android
---
...
<div class="tpl-content-sub-paragraph-normal">
  <p>
    What to do if your Motorola Razr 40 cannot play AVCHD .mts video clips? Depending on your device model, source media parameters, as well as the media player you are using, you may fail or have problems playing AVCHD MTS files on your Motorola Razr 40. In this article, we explain a solution to solve the issue. 
  </p>
</div>
</div>
...
<div class="tpl-content-sub-paragraph-question">
  “I'm trying to figure out what I'm going to do with AVCHD .mts files on my Motorola Razr 40. They were taken with a Panasonic camera. I’d like to watch them on Motorola Razr 40, but it refused to play them. So I'm stuck. Has anyone else figured out how to play the files in this .mts format on Motorola Razr 40? Any suggestions?”
</div>
<div class="tpl-content-sub-paragraph-content">
<p>
  The native video player on your Motorola Razr 40 will not support AVCHD files. However, you have two options to go through the issue. You can either install a third party video player (e.g. VLC player, MX player, MoboPlayer, etc.) or convert AVCHD .mts files to MP4 format via using a converter app. Check out a guide on how to re-encode AVCHD .mts files for playing on Motorola Razr 40.
</p>
</div>
</div>
