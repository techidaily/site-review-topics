---
title: MOV files are unwatchable on Xperia 5 V
date: 2024-05-19T18:09:37.623Z
tags: 
  - mov video
  - mov android
categories: 
...
keywords: does mov play on Sony Xperia 5 V,play .mov on Sony Xperia 5 V,can't open .mov on Sony Xperia 5 V,.mov playback on Xperia 5 V,can't open .mov on Xperia 5 V,will mov play on Xperia 5 V,Sony Xperia 5 V wont play mov,tv Sony mov 265,mov codec vlc android,mov converter for android,mov to h264 converter android,video to mp4 codec converter for android
---
...
<div class="tpl-content-sub-paragraph-content">
  <p>
    Have you ever tried to play a QuickTime .mov file on your Sony Xperia 5 V? Maybe some of them are .mov video clips you recorded on your iPhone. Many people these days have a mix of Android and iOS devices. Recording video clips on an iPhone will save the files with .mov file extension. It is well-known that Android platform doesn’t come with native support for QuickTime .mov media format. To play all kinds of MOV files on Sony Xperia 5 V, you may either download and install a third-party media player, or convert MOV to Sony Xperia 5 V supported MP4 format. The following content explains how to process MOV to Sony Xperia 5 V conversion step by step.
  </p>
</div>
</div>
