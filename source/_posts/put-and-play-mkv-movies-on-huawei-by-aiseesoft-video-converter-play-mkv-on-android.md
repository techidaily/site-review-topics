---
title: Put and play MKV movies on Huawei 
date: 2024-04-29T22:45:59.503Z
tags: 
  - mkv video
  - mkv android
categories: 
...
keywords: can't play mkv on Huawei ,mkv playback on Huawei ,app to play mkv on Huawei Nova Y71,watch mkv on Nova Y71,best mkv to Huawei  converter,convert MKV for Huawei Nova Y71 playing,mkv to mp4 video converter for android,mkv codec vlc android,tv Huawei mkv 265,mkv converter for android,720p to 4k converter for android,video to mkv codec converter for android
---
...
<div class="tpl-content-sub-paragraph-content">
  <p>
    Because MKV isn’t an industry standard, not all portable devices support it - even though support has grown rapidly. You have two main options for playing MKV files on Huawei Nova Y71: using an MKV compatible media player with appropriate codecs installed （e.g VLC player, MX Player）, or converting MKV files to the widely supported H.264 MP4 format if the first option doesn’t work. Check a quick guide on how to encode MKV files to H.264 MP4 for Huawei Nova Y71 playback.
  </p>
</div>
</div>
